...
# ---------------------------------------------------------------------------
# publish.sh — Build verification and npm publish for @romatech/orm-providers-memory
# ---------------------------------------------------------------------------
# Usage:
...
echo "============================================"
echo " @romatech/orm-providers-memory — publish pipeline"
echo "============================================"
echo ""
...
# 7. Publish
echo "[6/6] Publishing @romatech/orm-providers-memory@$NEW_VERSION to npm..."
npm publish --access public
echo ""

echo "============================================"
echo " Published @romatech/orm-providers-memory@$NEW_VERSION"
echo "============================================"
